    ...
    return (
        <>
            <footer className="w-full flex flex-col py-8 max-w-screen-xl mx-auto text-muted-foreground">
                ...
                <div className="w-full text-sm flex md:flex-row items-center justify-center md:space-y-0 md:space-x-2 ">
                    <span>
                        © {new Date().getFullYear()}
                    </span>
                    <span className="inline-block">·</span>
                    <span className="inline-block">DingWan</span>
                    <span className="inline-block">·</span>
                    ...
                    <span className="hidden md:inline-block">·</span>
                    <a target="_blank" aria-label="X公网安备XXX号" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 underline-offset-4 hover:underline text-muted-foreground hover:text-primary px-0 py-0 h-5 md:h-10 font-normal md:font-medium" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=36100002000386">
                        {/* <img alt="X公网安备XXX号" loading="lazy" width="18" height="18" decoding="async" data-nimg="1" className="mr-1 -translate-y-[1px]" style="color:transparent" srcSet="/_next/image?url=%2Fimages%2Fgongan.png&amp;w=32&amp;q=75 1x, /_next/image?url=%2Fimages%2Fgongan.png&amp;w=48&amp;q=75 2x" src="/_next/image?url=%2Fimages%2Fgongan.png&amp;w=48&amp;q=75" />
                        <span>X公网安备XXX号</span>
                    </a> */}
                </div>
            </footer>
